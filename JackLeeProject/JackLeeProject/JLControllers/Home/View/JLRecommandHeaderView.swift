...
class JLRecommandHeaderView: UICollectionReusableView {
    ...
    @objc func moreButtonClick(moreButton:UIButton){
        ///闭包回调  守护
        guard let headerMoreClick = headerMoreClick else { return  }
        headerMoreClick()
    }
    ...
    var homeRecommendList: JLRecommandModel?{
        didSet{
