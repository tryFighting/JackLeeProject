//
//  JLBaseWebController.swift
//  JackLeeProject
//
//  Created by zrq on 2019/8/2.
...
class JLBaseWebController: JLBaseViewController {
    lazy var wkwebview: WKWebView = {
        ...
        let  wk = WKWebView(frame: CGRect(x: 0, y: 64, width: 375,height: 667), configuration: config)
    ...
    lazy var progress: UIProgressView = {
        ...
        prog.frame = CGRect(x: 0, y: 64, width: 375, height: 3)
        prog.progressTintColor = UIColor.red
        prog.trackTintColor = UIColor.yellow
        prog.alpha = 1.0
        return prog
    }()
...
//            let new = (change?[NSKeyValueChangeKey.newKey] as? NSString)?.doubleValue
//            if new! == 1{
//
//            }
//        }
